...
public class UserUpdateValidator implements ConstraintValidator<UserUpdate, UserNewFormDTO> {
	...
	@Override
	public boolean isValid(UserNewFormDTO obj, ConstraintValidatorContext context) {
